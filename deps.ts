...
export { parse as flagsParse } from "https://deno.land/std@0.137.0/flags/mod.ts";
export type { Args } from "https://deno.land/std@0.137.0/flags/mod.ts";
export {
  parse as yamlParse,
...
} from "https://deno.land/std@0.137.0/streams/mod.ts";
