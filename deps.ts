...
export { parse as flagsParse } from "https://deno.land/std@0.133.0/flags/mod.ts";
export type { Args } from "https://deno.land/std@0.133.0/flags/mod.ts";
export {
  parse as yamlParse,
  stringify as yamlStringify,
} from "https://deno.land/std@0.133.0/encoding/yaml.ts";
export {
  readableStreamFromReader,
  writableStreamFromWriter,
} from "https://deno.land/std@0.133.0/streams/mod.ts";
